...
import { SnappyHeadView } from './components/SnappyHeadView.js';
...
import { isBrowserRuntime, isSnappyHeadMode } from './runtime.js';
...
function App() {
  ...
  if (isSnappyHeadMode) {
    return <SnappyHeadView officeState={officeState} layoutReady={layoutReady} />;
  }
